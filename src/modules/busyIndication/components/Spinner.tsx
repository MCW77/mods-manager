...
const Spinner = observer(
  () => {
    ...
    return (
      <Show if={isBusy$.get()}>
        <div className={`absolute inset-0 bg-black/50 m-0 p-2 z-300 text-center
          before:content-[''] before:inline-block before:h-full before:align-middle
        `}
        >
          <div className={`inline-block align-middle rounded-[100%] w-[5em] h-[5em] border-y-[#eeca44] border-x-transparent border-4 border-solid relative animate-[2s_linear_spin-slow_infinite] box-border
