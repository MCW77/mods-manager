...
const PrimaryStatRestrictionsWidget = observer(
	({ primaryRestrictions$ }: ComponentProps) => {
		return (
        ...
        `}
						...
						<ReactiveToggleGroup
							...
							onValueChange={(value) => {
								if (value === "") primaryRestrictions$.arrow.delete();
								else
									primaryRestrictions$.arrow.set(
        ...
        `}
						...
						<ReactiveToggleGroup
							...
							onValueChange={(value) => {
								if (value === "") primaryRestrictions$.triangle.delete();
								else
									primaryRestrictions$.triangle.set(
										value as PrimaryStats.GIMOStatNames,
									);
							}}
						>
          ...
          `}
						...
						<ReactiveToggleGroup
							...
							onValueChange={(value) => {
								if (value === "") primaryRestrictions$.cross.delete();
								else
									primaryRestrictions$.cross.set(
										value as PrimaryStats.GIMOStatNames,
									);
							}}
						>
          ...
          `}
						...
						<ReactiveToggleGroup
							...
							onValueChange={(value) => {
								if (value === "") primaryRestrictions$.circle.delete();
								else
									primaryRestrictions$.circle.set(
										value as PrimaryStats.GIMOStatNames,
									);
							}}
						>
