...
const SET_BG_POSITIONS = {
	...
	GREY_SPEED: "bg-[position:-72px_-0px]",
	GREY_CRIT_CHANCE: "bg-[position:-96px_-0px]",
	GREY_CRIT_DMG: "bg-[position:-120px_-0px]",
	...
	GREEN_SPEED: "bg-[position:-72px_-24px]",
	GREEN_CRIT_CHANCE: "bg-[position:-96px_-24px]",
	GREEN_CRIT_DMG: "bg-[position:-120px_-24px]",
	...
	BLUE_SPEED: "bg-[position:-72px_-48px]",
	BLUE_CRIT_CHANCE: "bg-[position:-96px_-48px]",
	BLUE_CRIT_DMG: "bg-[position:-120px_-48px]",
	...
	PURPLE_SPEED: "bg-[position:-72px_-72px]",
	PURPLE_CRIT_CHANCE: "bg-[position:-96px_-72px]",
	PURPLE_CRIT_DMG: "bg-[position:-120px_-72px]",
	...
	GOLD_SPEED: "bg-[position:-72px_-96px]",
	GOLD_CRIT_CHANCE: "bg-[position:-96px_-96px]",
	GOLD_CRIT_DMG: "bg-[position:-120px_-96px]",
