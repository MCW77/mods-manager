...
import { CharacterSummaryStats as CSStats, type PrimaryStats, type SecondaryStats, type SetStats} from "./Stats";
...
*/
		...
		getFlatValuesForCharacter(character: Character.Character) {
			const statPropertyNames =
				Stat.display2CSGIMOStatNamesMap[this.getDisplayType()];
		...
		getOptimizationValue(
			...
			const statTypes: OptStats =
				"Physical Critical Chance" === this.getDisplayType()
					? ["Critical Chance"]
